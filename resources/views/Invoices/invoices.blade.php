                        ...
                        <table>
                            <tr id="sin">
                                ...
                                <td>
                                    ...
                                    <input type="text" name="shoulder_leight" value="{{$info_size_customer->customer->phone}}">
                                </td>
                                <td>
                                    <label for="">عدد الثياب</label><br>
                                    <input type="text" name="brest" value="{{$info_size_customer->customer->number_dresses}}">
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="expand_hand" value="{{$info_size_customer->customer->code}}">
                                </td>
                                <td>
                                    <label for="">رقم الفاتورة</label><br>
                                    <input type="text" name="down_hand" value="{{$info_size_customer->customer->invoice_number}}">
                                </td>
...
@endphp
                        ...
                        <table>
                            <tr id="sin">
                                ...
                                <td>
                                    ...
                                    <input type="text" name="shoulder_leight"  value="{{$info_size_customer->shoulder_leight}}">
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="expand_brest"  value="{{$info_size_customer->expand_brest}}">
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="expand_hand"  value="{{$info_size_customer->expand_hand}}">
                                </td>
                                <td>
                            ...
                            <tr id="sin">
                                <td>
                                    ...
                                    <input type="text" name="pocket_leight"  value="{{$info_size_customer->pocket_leight}}">
                                </td>
                                <td>
                                    <label for="">وسع الجيب</label>
                                    <input type="text" name="pocket_expand"  value="{{$info_size_customer->pocket_expand}}">
                                </td>
                                <td>
                                    <label for="">وسع اسفل</label>
                                    <input type="text" name="down_expand"  value="{{$info_size_customer->down_expand}}">
                                </td>
                                <td>
                                    <label for="">كفة اسفل</label>
                                    <input type="text" name="down_desist"  value="{{$info_size_customer->down_desist}}">
                                </td>
                            </tr>
                        </table><br>
                        <hr>
                        <div id="idhight">
                            <div class="radio">
                                ...
                                <table>
                                    ...
                                    <input type="text" value="{{$info_size_customer->design->name_design}}"></td><td>
                                    <label for="">القماش</label>
                                    <input type="text" value="{{$info_size_customer->fabric->type_fabrice}}"></td><td>
                                    <label for="">اللون القماش</label>
                                    <input type="text" value="{{$info_size_customer->fabric->color_fabrice}}"></td><td>
                                    <label for="">اسم الخياط</label>
                                    <input type="text" value="{{$info_size_customer->seamoer->name}}"></td><td>
                                    <label for="">الخصم</label>
                                    <input type="text" value="{{$info_size_customer->discount}}"></td><td>
                                    <label for="">السعر شامل الضريبة</label>
                                    <input type="text" value="{{$info_size_customer->price_include_tax}}"></td><td>
                                    <label for="">السعر غير شامل الضريبة</label>
                                    <input type="text" value="{{$info_size_customer->price_doesnot_include_tax}}"></td><td>
                                    </tr>
                                </table>
                                <div class="radio">
                    ...
                    <div class="counttable">
                        ...
                        <div class="styletable">
                            ...
                            <td>
                                ...
                                <input type="text" name="price_doesnot_include_tax" id="tax" readonly value="{{$price_doesnot_include_tax}}">
                            </td>
                        </tr>
                            <tr>
                                <td>
                                    <label for="">الاجمالي الخصم</label><br>
                                    <input type="text" name="discount" id="discount" value="{{$discount}}">                                </td>
                                <td>
                                    <label for="">الاجمالي مبلغ الضريبة</label><br>
                                    <input type="text" name="value_tax" id="value_tax" value="{{$value_tax}}" readonly>                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="receivedamount" id="receivedamount" value="{{$receivedamount}}">
                                </td>
                                <td>
                                    <label for="">المبلغ المتبقي</label><br>
                                    <input type="text" name="remainingamount" id="remainingamount" readonly value="{{$remainingamount}}">                                </td>
                            </tr>
                            </table>
                        </div>
                    </div>
            ...
            </div><div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">


                <button class="btn ripple btn-primary" type="button"
                style="margin-right: 95%; margin-bottom:10%" onclick="printDiv()">طباعة</button>
            </div>
