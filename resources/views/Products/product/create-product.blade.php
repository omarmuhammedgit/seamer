                ...
                <div class="card-body">
                        ...
                        <table>
                            <tr>
                                ...
                                <td><label for="">رقم المنتج</label><br>
                                    <input type="text" name="no_product" placeholder="رقم المنتج" required>
                                </td>
                            ...
                            <tr>
                                <td><label for="">تنبيه الكمية</label><br>
                                    <input type="text" name="quantity_alert" placeholder="تنبيه الكمية" required>
                                </td>
                    ...
                    <div id="price_product_purchas" style="display: none">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="price_purchas_include_tax" placeholder="سعر شامل الضريبة">
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <label for=""> سعر غير شامل الضربية</label>
                                    <input type="text" name="price_purches_doesnot_include_tax" placeholder="سعر غير شامل الضريبة">
                                </div>
                            </td>
                    </div>
                        </tr>
                    ...
                    <table>
                        <tr>
                            <td><label for="">سعر شامل الضربية</label><br>
                                <input type="text" name="price_sale_include_tax" placeholder="سعر شامل الضريبة">
                            </td>
                            <td><label for="">سعر غير شامل الضربية</label><br>
                                <input type="text" name="price_sale_doesnot_include_tax" placeholder="سعر غير شامل الضريبة">
                            </td>
                            <td><label for="">نسبة مئوية /نسبة ثابتة</label><br>
                                <input type="text" name="rale" placeholder="نسبة المئوية">
                            </td>
                            <td><label for="">الاجمالي</label><br>
                                <input type="text" name="total" placeholder="الاجمالي">
                            </td>
                        </tr>
                    </table>
                    </div>
                    ...
                    <table>
                        <tr>
                            <td><label for="">اجمالي الرصيد الافتتاحي</label><br>
                                <input type="number" name="total_opening_balance" placeholder="الرصيد افتتاحي" required>
                            </td></tr></table>
