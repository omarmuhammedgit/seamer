                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input type="text" name="contactId" placeholder="رقم السجل التجاري" required >
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                ...
                                <input type="text" name="sobriquet" placeholder="السيد"  >
                            </div>
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="text" name="lastname" placeholder="اسم العائلة">
                            </div>
                            <div class="col-lg-4">
                                <label><span>تاريخ الميلاد</span></label><br>
                                <input type="date" name="datebirth" placeholder="البريد الالكتروني"  >
                            </div>
                            <div class="col-lg-4">
                                <label><span>مخصص ل:</span></label><br>
                                <input type="text" name="allotted" >
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                <input type="text" name="activisms" placeholder="اسم النشاط"  >
                            </div>
                            <div class="col-lg-4">
                                <label><span>مخصص ل:</span></label><br>
                                <input type="text" name="allotted" >
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input type="text" name="facilitynumber" placeholder="رقم الجوال المنشاة">
                            </div>
                            <div class="col-lg-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input type="text" name="initial_balance" placeholder="الرصيد الافتتاحي">
                            </div>
                            <div class="col-lg-3">
                                <label><span>فترةالدفع</span></label>
                                <input type="text" name="payment_period" placeholder="فترة الدفع">
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input type="text" name="postal_code" placeholder="الرمزالبريدي" required>
                            </div>
